...
hi("Cursor",       { fg = p.white, bg = p.green })
...
hi("@function",               { fg = p.green })
hi("@function.builtin",       { fg = p.green, italic = true })
...
hi("@type.builtin.c",            { fg = p.yellow, italic = true })
hi("@type.builtin.cpp",          { fg = p.yellow, italic = true })
...
hi("@type.builtin.go",           { fg = p.yellow, italic = true })
...
hi("@type.builtin.zig",          { fg = p.yellow, italic = true })

-- Shell / Bash
hi("@keyword.bash",              { fg = p.red })
hi("@function.builtin.bash",     { fg = p.blue, italic = true })
...
hi("@function.builtin.r",        { fg = p.green, italic = true })
...
hi("@type.builtin.julia",        { fg = p.yellow, italic = true })
...
hi("@type.builtin.odin",         { fg = p.yellow, italic = true })
...
hi("@type.builtin.glsl",         { fg = p.yellow, italic = true })
...
hi("@type.builtin.hlsl",         { fg = p.yellow, italic = true })
hi("@keyword.directive.hlsl",    { fg = p.indigo })

hi("@keyword.wgsl",              { fg = p.red })
hi("@type.wgsl",                 { fg = p.yellow })
hi("@type.builtin.wgsl",         { fg = p.yellow, italic = true })
...
hi("@type.builtin.fortran",      { fg = p.yellow, italic = true })
...
hi("@type.builtin.verilog",      { fg = p.yellow, italic = true })
...
hi("@type.builtin.vhdl",         { fg = p.yellow, italic = true })
...
hi("@type.builtin.solidity",     { fg = p.yellow, italic = true })
...
hi("@function.builtin.nix",      { fg = p.green, italic = true })
...
hi("@type.builtin.proto",        { fg = p.yellow, italic = true })
...
hi("@function.builtin.typst",    { fg = p.green, italic = true })
...
hi("@function.builtin.cmake",    { fg = p.green, italic = true })
...
hi("@function.builtin.meson",    { fg = p.green, italic = true })
...
hi("@function.builtin.fish",     { fg = p.green, italic = true })
...
hi("@type.builtin.luau",         { fg = p.yellow, italic = true })
...
hi("@function.builtin.awk",      { fg = p.green, italic = true })
...
hi("@function.builtin.tcl",      { fg = p.green, italic = true })
...
hi("@function.builtin.vim",      { fg = p.green, italic = true })
...
hi("@function.builtin.starlark", { fg = p.green, italic = true })
...
hi("@type.builtin.prisma",       { fg = p.yellow, italic = true })
...
hi("@type.builtin.d",            { fg = p.yellow, italic = true })
...
hi("@function.builtin.matlab",   { fg = p.green, italic = true })
...
hi("@type.builtin.dhall",        { fg = p.yellow, italic = true })
...
hi("@lsp.type.typeParameter", { fg = p.yellow, italic = true })
